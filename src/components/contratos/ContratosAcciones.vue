<template>
  ...
  <div class="d-flex justify-content-end align-items-center gap-1 flex-wrap">
    <button type="button" class="btn btn-sm btn-outline-success me-1" :disabled="!puedeEnviar"
      ...
      @click="enviarWhatsApp" @click.stop>
      <i class="fa-brands fa-whatsapp"></i>
    </button>
    <button type="button" class="btn btn-sm btn-outline-primary me-1" @click="$emit('ver', contrato)" title="Ver" @click.stop v-if="variant === 'desktop'"> 
      <i class="fa-solid fa-eye"></i>
    </button>
    <button type="button" class="btn btn-sm btn-outline-secondary me-1" @click="$emit('sugerencia', contrato)"
      title="Sugerencia de publicación" @click.stop>
      <i class="fa-solid fa-bullhorn"></i>
    </button>
    <button type="button" class="btn btn-sm btn-outline-primary me-1" @click="$emit('editar', contrato)" title="Editar" @click.stop>
      <i class="fa-solid fa-pen"></i>
    </button>
    <button type="button" class="btn btn-sm btn-outline-danger" @click="$emit('eliminar', contrato)" title="Eliminar" @click.stop>
